<template>
  <div ref="container" class="containers">
    ...
    <!-- {{modeler}} -->
    <properties-view  v-if="modeler" :modeler="modeler"></properties-view>
  </div>
</template>
...
export default {
  ...
  async mounted() {
    ...
    if (this.propertiesPanel === "" || this.propertiesPanel) {
      additionalModules = additionalModules.concat([propertiesPanelModule, propertiesProviderModule]);
    }
    ...
    //   debugger
    // })
    console.log(this.modeler,'333333333333')
  ...
  methods: {
    ...
    //   console.log(this.modeler, "222222222222222");
...
.properties-panel-parent {
  ...
  /deep/ .bpp-table-row > label.bpp-table-row-columns-2.bpp-table-row-removable,
  /deep/ .bpp-table-row > input.bpp-table-row-columns-2.bpp-table-row-removable {
    width: calc(50% - 12px);
  }
}
</style>
